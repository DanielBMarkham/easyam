    ...
    and [<NoComparison>] ModelItem =
        ...
        with
            ...
            member self.HasAModelParent = 
                self.ModelParent<>0
    and [<NoComparison>] ProcessContext = {ContextStack:System.Collections.Generic.Stack<ModelItem>; Lines:ModelItem list; LastAddedModelItem:ModelItem}
